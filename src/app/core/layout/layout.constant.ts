...
export const HOME_ID = {
  ...
  BUTTON_NOTIFICATIONS: `${FEATURES.HOME}-${HTML_ELEMENTS.BUTTON}-notifications`,
  ...
  MENU_PRODUCTS: `${FEATURES.HOME}-${HTML_ELEMENTS.BUTTON}-menuProducts`,
  MENU_SALES_ORDERS: `${FEATURES.HOME}-${HTML_ELEMENTS.BUTTON}-menuSalesOrders`,
  MENU_REPORTS: `${FEATURES.HOME}-${HTML_ELEMENTS.BUTTON}-menuReports`,
  MENU_TASKS: `${FEATURES.HOME}-${HTML_ELEMENTS.BUTTON}-menuTasks`,
